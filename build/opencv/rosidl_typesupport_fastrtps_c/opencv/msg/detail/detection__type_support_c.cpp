...
#include "opencv/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
#include "opencv/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Detection__ros_msg_type = opencv__msg__Detection;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opencv
size_t get_serialized_size_opencv__msg__Detection(
  const void * untyped_ros_message,
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_opencv__msg__Detection(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opencv
size_t max_serialized_size_opencv__msg__Detection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opencv__msg__Detection;
    is_plain =
      (
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_opencv__msg__Detection(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv, msg, Detection)() {

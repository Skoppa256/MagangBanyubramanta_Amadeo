...
bool opencv__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("opencv.msg._detection.Detection", full_classname_dest, 31) == 0);
  }
  opencv__msg__Detection * ros_message = _ros_message;
  {  // red
...
PyObject * opencv__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("opencv.msg._detection");
